    ...
    <div class="container">
        <div class="partner-slider">
            <div class="partner-child">
                <picture>
                    <img src="../dist/img/Rectangle 16.png" alt="">
                </picture>
            </div>
            <div class="partner-child">
                <picture>
        ...
        <footer class="row">
            <div class="footer-left col-lg-5">
                <div class="logo-footer">
                    ...
                    <p>We ara a lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a>Read More</a></p>
                </div>
                <div class="contact">
                    <div class="phone">
                        <div class="image">
                            <picture>
                                <img src="../dist/img/Icon-phone.svg" alt="">
                            </picture>
                        </div>
                    ...
                    <div class="mail">
                        <div class="image">
                            <picture>
                                <img src="../dist/img/Icon-mail.svg" alt="">
                            </picture>
                        </div>
                        <div class="mail-text">
                            <p>Mail</p>
                            <h6>unreal@outlook.com</h6>
                        </div>
                    </div>
                    <div class="location">
                        <div class="image">
                            <picture>
                                <img src="../dist/img/Icon-location.svg" alt="">
                            </picture>
                        </div>
